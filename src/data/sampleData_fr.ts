...
export const sampleData_fr: TimelineStage[] = [
    {
        id: 'stage-1',
        ...
        stories: [
            {
                id: 'story-1',
                title: 'Le Garçon Qui Poursuivait le Soleil',
                description: 'Le rire d’un garçon se noie dans l’encre de la guerre, jusqu’à ce que l’amour lui apprenne à lire l’obscurité.',
...
Jusqu’au jour où le bouclier se fissura.`,
                        isRead: false,
                    }
                ]
            }
    ...
    },
    {
        ...
        title: 'Le Tournant',
        year: "24-02-2022",
        description: 'Quand tout a changé...',
        isUnlocked: false,
        requiresAllChaptersRead: true,
        stories: [
            {
...
Jusqu’au jour où le bouclier se fissura.`,
                    ...
                    {
                        id: 'ch-2-2',
                        title: 'La Note Qui Vola le Rire',
                        description: 'Une lettre d’amour atterrit dans ses mains comme un oiseau blessé, ses trois mots réduisant son rire au silence pour toujours.',
                        mood: 'melancholic',
                        content: `# La Note Qui Vola le Rire
...
Et bien qu’il ne puisse plus rire, ses mains restèrent propres.`,
                        isRead: false,
                    }
                ]
            },
    ...
    {
        id: 'stage-3',
        title: 'La Lumière Qui Ne S’Éteint Jamais',
        year: "26-06-2024",
        description: 'Une lumière intérieure encore à rallumer...',
        isUnlocked: false,
        requiresAllChaptersRead: true,
        stories: [
            {
                ...
                chapters: [
                    {
                        id: 'ch-3-1',
                        title: "L'homme qui marchait avec le rire",
                        description: "Un homme traverse le monde comme un pinceau trempé dans l'or, peignant la joie sur chaque surface fissurée qu'il touche",
                        mood: "hopeful",
                        content: `# L'homme qui marchait avec le rire
...
Le monde est lourd. Mais lui ne l’est pas.`,
    ...
    {
        id: 'stage-4',
        title: 'Une Lumière, Ravivée Une Nouvelle Fois',
        year: "14-12-2024",
        description: 'Une lumière, autrefois éteinte, est rallumée une nouvelle fois...',
        isUnlocked: false,
        requiresAllChaptersRead: true,
        stories: [
            {
                id: 'story-4',
                title: "L'homme qui fuyait en cercles",
                description: "Un homme se démembre pièce par pièce, jusqu'à ce qu'une note murmure son vrai nom.",
...
Le spectacle avait enfin trouvé son public.`,
                        isRead: false,
                    }
                ]
            },
    ...
    {
        id: 'stage-5',
        title: 'La Lumière Qui Continue de Brûler',
        year: "02-02-2025",
        description: 'Une lumière, autrefois éteinte, est rallumée une nouvelle fois, mais cette fois, elle n’est pas seule...',
        isUnlocked: false,
        requiresAllChaptersRead: true,
        stories: [
            {
...
Son ennemi. Son Moby Dick. Il attendait dans les coins des pièces, dans l’espace entre les battements de cœur, et il le combattait avec des blagues, des chansons, des "Savais-tu que—?" et "Tu te souviens quand—?" jusqu’à ce que l’air lui-même se fatigue.`,
    ...
    {
        id: 'stage-6',
        title: 'La Lumière Qui Continue de Brûler, mais cette fois, elle n’est pas seule',
        year: "27-06-2025",
        description: 'Une lumière, autrefois éteinte, est rallumée une nouvelle fois, mais cette fois, elle n’est pas la seule lumière...',
        isUnlocked: false,
        requiresAllChaptersRead: true,
        stories: [
            {
...
Le spectacle avait enfin trouvé son public.`,
                    ...
                    {
                        id: 'ch-7-4',
                        title: 'La Gravité de Deux Étoiles Tombantes',
...
Mais cette nuit-là, sous un ciel qui avait depuis longtemps oublié comment témoigner des miracles, ils pressèrent leurs fronts l’un contre l’autre et le murmurèrent quand même.`,
                        isRead: false,
                    }
                ]
            },
            {
                id: 'story-8',
                title: 'Son ombre, le projecteur',
                description: 'Un artiste soigne ses accessoires mourants, répétant une scène d’amour que personne ne verra.',
...
Et la plus grande performance est celle où le public ne pense jamais à demander ce qu’il y a en dessous.`,
                        isRead: false,
                    },
                    {
                        id: 'ch-8-2',
                        title: 'Soliloque en Boîte de Verre',
                        description: "Minuit le trouve répétant des sonnets d’amour à un miroir fissuré, tandis qu’une rose mourante le regarde depuis son cercueil de verre comme un critique désapprobateur.",
                        mood: "melancholic",
...
Les pétales restants de la rose devenaient plus parfaits à mesure qu’ils se fragilisaient. Il les avait bien entraînés. Aucun public ne devinerait depuis combien de temps ils étaient morts.`,
            ...
            {
                id: 'story-9',
                title: 'La Constellation de Peut-Être',
                description: 'Un amoureux marche sur le fil du rasoir entre et si et malgré tout, comptant ses battements de cœur comme des prières',
...
Mais pour l’instant, il marchait.`,
    ...
    {
        id: 'stage-7',
        title: 'La Lumière Qui Continue de Brûler, pour toujours',
        year: "28-06-2025 - pour toujours",
        description: 'Une lumière, autrefois éteinte, est rallumée une nouvelle fois, mais cette fois, elle n’est pas la seule lumière, et elle ne s’éteint jamais',
        isUnlocked: false,
        requiresAllChaptersRead: true,
        stories: [
            {
...
Pour boire la preuve de son propre saignement.`,
                        isRead: false,
                    },
                    {
                        id: 'ch-10-4',
                        title: 'Le Dernier Monologue du Mime',
                        description: "Au centre de la scène, il ouvre la bouche et laisse la vérité non scriptée s’échapper : brute, difforme, et plus belle que toute performance qu’il ait jamais planifiée.",
                        mood: "hopeful",
...
Quelque part, une rose s’effrita enfin en poussière.`,
                        isRead: false,
                    }
                ]
            },
...
Mais pour l’instant, il marchait.`,
                    ...
                    {
                        id: 'ch-11-2',
                        title: 'Le Refuge du Prince Étoile dans la Maison des Ombres Brûlantes',
                        description: "Trois anomalies terrestres lui enseignent que la gravité fonctionne de travers pour les corps célestes égarés.",
                        mood: "hopeful",
...
Comme une carte pour rentrer chez lui.`,
                        isRead: false,
                    },
                    {
                        id: 'ch-11-3',
